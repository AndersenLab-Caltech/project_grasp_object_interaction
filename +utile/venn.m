...
%   figure()
%   subplot(1,3,1), h1 = utile.venn(A,I,'ErrMinMode','None');
%   axis image,  title ('No 3-Circle Error Minimization')
%   subplot(1,3,2), h2 = utile.venn(A,I,'ErrMinMode','TotalError');
%   axis image,  title ('Total Error Mode')
%   subplot(1,3,3), h3 = utile.venn(A,I,'ErrMinMode','ChowRodgers');
...
%   [H,S] = utile.venn(A,I,F,'ErrMinMode','ChowRodgers','FaceAlpha', 0.6);
% 
%   %Now label each zone 
%   for i = 1:7
