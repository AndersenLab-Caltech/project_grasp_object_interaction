function error = vennX( data, resolution, Labels1 )
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%     
   ...
   if length( data ) == 3
      ...
      %[18,61,132]
      %[34,122,165]
      ColorsM =  utile.get_color_rgb_codes(Labels1);
...
%     if ~isempty(Labels1)
%     ColorsCues = utile.get_color_rgb_codes(Labels1);
% 
%     colormap([...
%     1,1,1;... %0
%     ColorsCues{1};... %1
...
function error = plot_venn3( a, b, c, d, e, f, g, resolution, dist_A_B, dist_B_C, dist_A_C )
    ...
    if flagPercentage
        h = text( text_x, text_y, [num2str( round(e/sumVenn*100)) '%' ], 'FontSize',14);
    else
    ...
    if flagPercentage
        h = text( text_x, text_y, [num2str( round(f/sumVenn*100)) '%' ], 'FontSize',14);
    else
    ...
    if flagPercentage
         h = text( text_x, text_y, [num2str(round(g/sumVenn*100)) '%' ], 'FontSize',14);
    else
...
function error = plot_venn2( a, b, c, resolution, dist )
    ...
    text_y = mean(i);
     ...
     if flagPercentage
        h = text( text_x, text_y, [num2str(round(a/sumVenn*100)) '%' ], 'FontSize',14);
    else
        h = text( text_x, text_y, num2str( a ) );
     end 
    ...
    text_y = mean(i);
     ...
     if flagPercentage
        h = text( text_x, text_y, [num2str(round(b/sumVenn*100)) '%' ], 'FontSize',14);
    else
        h = text( text_x, text_y, num2str(b) );
     end 
    ...
    text_y = mean(i);
     ...
     if flagPercentage
        h = text( text_x, text_y, [num2str( round(c/sumVenn*100)) '%' ], 'FontSize',14);
    else
        h = text( text_x, text_y, num2str(c) );
     end 
    ...
    xL=xlim;
    yL=ylim;
    text(xL(1) + 1,0.99*yL(1),['N = ' num2str(a)],'HorizontalAlignment','left','VerticalAlignment','top', 'FontSize', 14)
    text(0.99*xL(2),0.99*yL(1),['N = ' num2str(b)],'HorizontalAlignment','right','VerticalAlignment','top', 'FontSize', 14)
    text(xL(2),yL(2) -3,['N = ' num2str(c)],'HorizontalAlignment','right','VerticalAlignment','bottom', 'FontSize', 14)
