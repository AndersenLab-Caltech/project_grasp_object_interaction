...
% chose cue type:
taskCuesAll = {'Regular Images', 'Pixelated Images'}; %{'Hand', 'Hand-Object', 'Object'};
...
for n_session = 1:numSessions
    ...
    imageType = Go_data.Shuffled(idxThisSession,:);
