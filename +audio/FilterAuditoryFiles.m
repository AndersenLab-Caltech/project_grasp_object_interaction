...
%% STEP  1 - Save Files needed for extraction 
 for task_n = 1:length(good_datasets) 
        ...
        [FilteredRecorded,Fs2] = audioread('C:\Users\Sarah\Documents\Audio\WholeFileFiltered30.wav');
        [FilteredRecorded2,Fs2] = audioread('C:\Users\Sarah\Documents\Audio\WholeFileFiltered35.wav');
        [FilteredRecorded3,Fs2] = audioread('C:\Users\Sarah\Documents\Audio\WholeFileFiltered40.wav');

        FilteredRecorded = FilteredRecorded';
        FilteredRecorded2 = FilteredRecorded2';
        FilteredRecorded3 = FilteredRecorded3';
        for trial = 1
            ...
            audio_tmp2 = FilteredRecorded(StartIdx:EndIdx);
            audio_tmp3 = FilteredRecorded2(StartIdx:EndIdx);
            audio_tmp4 = FilteredRecorded3(StartIdx:EndIdx);
            ...
            %Envelope of signal: 
            env = envelope(audio_tmp, Fs/20, 'peak'); 
            time_axis = (1:size(audio_tmp,2)) / Fs; 
            
            env2 = envelope(audio_tmp2,Fs/20, 'peak');
...
%             
%             figure(); plot(time_axis, audio_tmp2);
%             hold on; plot(time_axis, env2, 'r');

            
%             figure();
%             plot(time_axis, audio_tmp); 
%             hold on
%             plot(time_axis, audio_tmp2);
%             hold on
%             plot(time_axis, audio_tmp3); 
%             hold on
%             plot(time_axis, audio_tmp4);
%             
%             figure()
%             hold on
%             plot(time_axis, audio_tmp2);
